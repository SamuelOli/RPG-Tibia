...
public class ItemDescription : MonoBehaviour {
	...
	public void SetDrescription () {
		if (item != null) {
			...
			txtHeroType.text = "Type: " + item.heroType.ToString ();
    ...
    public void SetDescriptionPosition()
    {
        ...
        txtHeroType.transform.position = new Vector3(posX, CalculateY(txtLvl), 0);
        txtDescription.transform.position = new Vector3(posX, CalculateY(txtHeroType), 0);
